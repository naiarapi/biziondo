...
<section id="contacto">
	...
	<div class="colcontacto col-md-12 col-xs-12">
		...
		<h3 class="titulos2">Kontaktua</h2>
	 ...
	 <div class="colcontacto col-md-12 col-xs-12">
		 ...
		 <h3 class="titulos2">Ordutegia</h2>
		 <p class="txtcontacto"><strong>De lunes a jueves </strong>: 9:30h a 13:30h y 16:00h a 20:00h</p>
		 <p class="txtcontacto"><strong>Ostirala </strong>: 9:30h a 14:00h</p>
		 <p class="txtcontacto"><strong>Larunbata</strong> : 10:00h a 14:00h</p>
	</div> 
	...
	<article id="email">
		...
		<h3 class="titulos2">Emaila bidali</h2>
	
	 <form name="form1" action="enviar.php" method="post" id="formcontacto" enctype="multipart/form-data">
           	
          	  <input name="cnomape" type="text" id="nombre" class="input2" value="Izena">

           	  <input name="ctelefono" type="text" id="telefono" class="input2" value="Mugikorra">
               
          	  <input name="cemail" type="text" id="email" class="input2" value="Emaila">
