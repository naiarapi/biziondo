...
<head>
<meta charset="utf-8">
<title>BiziOndo - Chiropraticiens</title>
...
<div id="img1" class="image1" >
	...
	<h1 class="animated fadeInUp col-lg-6" >Disfruta de buena salud, bienvenido a BiziOndo.</h2>
	<a href="#" class="btn btn-info btn-lg col-lg-2" data-toggle="modal" data-target="#myModal">PREND RENDEZ-VOUS</a>
...
<article id="quiropractica">
	...
	<div class="titulo">
		<h2 style="margin-top: 50px;">La chiropraxie</h2>
	</div>
	
	<div class="txt col-lg-12 col-md-12 col-xs-12">
		<p>C’est une thérapeutique visant à corriger les désordres neuro-squelettiques. En effet, les vertèbres ont tendance à se déplacer au cours de la vie selon les contraintes physiques de notre corps, créant ainsi une interférence au niveau du système nerveux, ayant un impact significatif sur notre santé.</p>
	</div>
...
<div id="tipos" class="col-lg-12 col-md-12- col-xs-12">
	...
	<div class="col col-lg-4 col-md-12 col-xs-12">
		<a href="quiro-fr.php">
			...
			<h3 class="subtutilos">LA FAMILLE ET LA CHIROPRAXIE</h3>
			</a>
	</div>
		...
		<a href="quiro-fr.php">
			...
			<h3 class="subtutilos">LA GROSSESSE</h3>
			</a>
		</div>
		...
		<a href="quiro-fr.php">
			...
			<h3 class="subtutilos">LE STRESS</h3>
			</a>
		</div>
...
<section id="cursos">
	...
	<?php 
		...
		<a href="cursos.php" class="mas">Voir plus</a>
...
<?php 	
include("includes/footer-fr.php");
?> 
