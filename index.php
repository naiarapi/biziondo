...
<head>
<meta charset="utf-8">
<title>BiziOndo - Quiroprácticos</title>
...
<div id="img1" class="image1" >
	...
	<h1 class="animated fadeInUp col-lg-6" >Mejora tu salud</h2>
	<a href="#" class="btn btn-info btn-lg col-lg-2" data-toggle="modal" data-target="#myModal">PIDE TU CITA</a>
...
<div class="modal fade" id="myModal" role="dialog">
 ...
 <div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-10 col-xs-offset-1">
            ...
            <div class="form-container-3">
              ...
              <form method="post" action="admin-cita-insertar.php" name="contacto" id="contacto">  
                ...
                <input id="email "name="email" type="text" size="25" maxlength="100" placeholder="Email" required />
...
<article id="quiropractica">
	...
	<div class="titulo">
		<h2 style="margin-top: 50px;">La Quiropráctica</h2>
	</div>
	
	<div class="txt col-lg-12 col-md-12 col-xs-12">
		<p>Es la ciencia de la salud que corrige las subluxaciones, es decir, vértebras que han ido perdiendo su alineación en la columna y están obstaculizando el funcionamiento del sistema nervioso y por lo tanto, nuestra salud.</p>
	</div>
...
<div id="tipos" class="col-lg-12 col-md-12- col-xs-12">
	...
	<div class="col col-lg-4 col-md-12 col-xs-12">
		<a href="quiro.php">
			...
			<h3 class="subtutilos"> EL CUIDADO PARA TODA LA FAMILIA </h3>
			</a>
	</div>
		...
		<a href="quiro.php">
			...
			<h3 class="subtutilos">EL EMBARAZO</h3>
			</a>
		</div>
		...
		<a href="quiro.php">
			...
			<h3 class="subtutilos">EL ESTRÉS</h3>
			</a>
		</div>
...
<section id="cursos">
	...
	<?php 
		...
		<a href="cursos.php" class="mas">Ver más</a>
